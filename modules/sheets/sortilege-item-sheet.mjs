...
export class SortilegeItemSheet extends ItemSheet {
    ...
    static get defaultOptions() {
      return foundry.utils.mergeObject(super.defaultOptions, {
        classes: ["prophecy", "sheet", "item", "sortilege"],
        template: "systems/prophecy-2e/templates/sortilege-item-sheet.html",
        width: 1050,
        height: 600,
    ...
    getData() {
      ...
      context.item.Disciplines = CONFIG.PROPHECY.MAGIE.Disciplines;
      context.item.Spheres = CONFIG.PROPHECY.MAGIE.Spheres;
    ...
    activateListeners(html) {
      ...
      loadHtmlEffets(this.item, html, true);
