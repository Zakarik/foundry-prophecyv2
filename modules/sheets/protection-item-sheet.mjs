...
export class ProtectionItemSheet extends ItemSheet {
    ...
    static get defaultOptions() {
      return foundry.utils.mergeObject(super.defaultOptions, {
        classes: ["prophecy", "sheet", "item", "armure"],
        template: "systems/prophecy-2e/templates/protection-item-sheet.html",
        width: 1050,
        height: 600,
    ...
    getData() {
      ...
      context.item.TypeArmures = CONFIG.PROPHECY.TypeArmures;
